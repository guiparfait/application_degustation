                                    ...
                                    @else
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td ><button type="button" title="Modifier" class="btn btn-outline-default waves-effect waves-light"><i class="ti-pencil-alt"></i></button></td>
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="form-group">
                        ...
                        <input class="form-control @error('libelle') is-invalid @enderror" name="libelle" value="{{ old('libelle') }}" id="libelle"/>
                        @error('libelle')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('arome') is-invalid @enderror" name="arome" id="arome" value="{{ old('arome') }}" cols="10" rows="3"></textarea>
                        @error('arome')
                            <span class="h6" style="color: red; font-style:italic;">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('saveur') is-invalid @enderror" name="saveur" value="{{ old('saveur') }}" id="saveur" cols="10" rows="3"></textarea>
                        @error('saveur')
                            <span class="h6" style="color: red; font-style:italic;">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('apparence') is-invalid @enderror" name="apparence" value="{{ old('apparence') }}" id="apparence" cols="10" rows="3"></textarea>
                        @error('apparence')
                            <span class="h6" style="color: red; font-style:italic;">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('sensation') is-invalid @enderror" name="sensation" value="{{ old('sensation') }}" id="sensation" cols="10" rows="3"></textarea>
                        @error('sensation')
                            <span class="h6" style="color: red; font-style:italic;">
                                <strong>{{ $message }}</strong>
                            </span>
