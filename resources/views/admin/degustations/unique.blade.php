            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('degustations.create') }}" class="btn btn-primary waves-effect waves-light"><i class="ti-plus"></i> Ajouter</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody class="text-center">
                                @if($data->isEmpty())
                                    <tr>
                                        <th colspan="11">Aucne dégustation enregistrée pour le moment.</th>
                                    </tr>
                                @else
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            @endphp
                                            <td>{{ $moy }}/10</td>
                                            <td ><a href="{{ route('degustations.edit',$item->id) }}" type="button" title="Modifier" class="btn btn-outline-warning waves-effect waves-light"><i class="ti-pencil-alt"></i></a></td>
                                            ...
                                            <td >
                                                ...
                                                onsubmit="return confirm('Être vous sûre de vouloir Supprimer cette degustation ? si oui tout les commentaires liés seront supprimés!') ">
                                                  ...
                                                  <input type="hidden" name="sens" value="mazone">
